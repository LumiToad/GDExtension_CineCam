...
void CineCam2D::_bind_methods()
{
	...
	ADD_GETSET_HINT_BINDING(_get_blend_data, _set_blend_data, blend_data, p_default_blend, CineCam2D, OBJECT, PROPERTY_HINT_RESOURCE_TYPE, "BlendData2D");
