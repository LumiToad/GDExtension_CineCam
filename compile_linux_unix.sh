...
scons platform=linux target=template_debug arch=x64 >> build_logs/linux/build_log_${fullstamp}.txt
echo "" >> build_logs/linux/build_log_${fullstamp}.txt
echo BUILD release_linux64 >> build_logs/linux/build_log_${fullstamp}.txt
scons platform=linux target=template_release arch=x64 >> build_logs/linux/build_log_${fullstamp}.txt
echo "" >> build_logs/linux/build_log_${fullstamp}.txt
